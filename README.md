...
This is a very broad introduction to R and R Studio for data analysis and visualisation in sports. A small set of [slides](https://github.com/edbrooks/R_for_sports_data/blob/main/slides/slides.html) can be found in this repository to get you started. There is also some example [code](https://github.com/edbrooks/R_for_sports_data/blob/main/scripts/basics_in_r.R) to step you through some basics, then some more [code](https://github.com/edbrooks/R_for_sports_data/blob/main/scripts/NBA_data_in_r.R) to show some sport specific examples using R and RStudio for [NBA data](https://github.com/edbrooks/R_for_sports_data/blob/main/data/NBA_2017-18_AdvancedStats_Salary.csv). This is intended to jump-start your journey into this vast area which forms an intersection of data science, sport science, statistics, design, and many other disciplines.
